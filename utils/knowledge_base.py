            ...
            "Statement": [
                {
                    ...
                    "Resource": [
                        ...
                        f"arn:aws:bedrock:{self.region_name}:{self.account_number}:inference-profile/{self.graph_model}" if self.graph_model.startswith(("us.", "eu.", "apac.", "global.")) else f"arn:aws:bedrock:{self.region_name}::foundation-model/{self.graph_model}",
                        f"arn:aws:bedrock:*::foundation-model/*",
                        f"arn:aws:bedrock:{self.region_name}:{self.account_number}:inference-profile/*"
                    ]
                },
                {
